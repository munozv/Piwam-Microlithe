            ...
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                var param = [{ "name": "calendarId", value: id },
							...
							{ "name": "CalendarEndTime", value: dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm") },
                                                        ...
                                                        { "name" : "ks_wc_event[id]", value: id },
                                                        { "name" : "ks_wc_event[start_time][year]", value: start.getFullYear() },
                                                        { "name" : "ks_wc_event[start_time][month]", value: start.getMonth()+1 },
                                                        { "name" : "ks_wc_event[start_time][day]", value: start.getDate() },
                                                        { "name" : "ks_wc_event[start_time][hour]", value: start.getHours() },
                                                        { "name" : "ks_wc_event[start_time][minute]", value: start.getMinutes() },
                                                        { "name" : "ks_wc_event[end_time][year]", value: end.getFullYear() },
                                                        { "name" : "ks_wc_event[end_time][month]", value: end.getMonth()+1 },
                                                        { "name" : "ks_wc_event[end_time][day]", value: end.getDate() },
                                                        { "name" : "ks_wc_event[end_time][hour]", value: end.getHours() },
                                                        { "name" : "ks_wc_event[end_time][minute]", value: end.getMinutes() },
							{ "name": "timezone", value: zone }
						   ];
                var d;
                ...
                calbutton.click(function(e) {
                    ...
                    var param = [{ "name": "CalendarTitle", value: what },
						...
						{ "name": "CalendarEndTime", value: dateend },
                                                { "name" : "ks_wc_event[subject]", value: what },
                                                { "name" : "ks_wc_event[start_time][year]", value: start.getFullYear() },
                                                { "name" : "ks_wc_event[start_time][month]", value: start.getMonth()+1 },
                                                { "name" : "ks_wc_event[start_time][day]", value: start.getDate() },
                                                { "name" : "ks_wc_event[start_time][hour]", value: start.getHours() },
						...
						{ "name": "ks_wc_event[is_all_day_event]", value: allday },
						{ "name": "timezone", value: zone}];

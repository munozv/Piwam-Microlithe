...
<ul class="domtabs">
    ...
    <li><a href="#t4">Historiques des Activites</a></li>
</ul>
    ...
    <table class="details">
        ...
        <tbody>
            ...
            <tr>
		       ...
		       <td><?php
		       if (MemberTable::getByUsername($member->getTutor()) != NULL)
			 echo format_member(MemberTable::getByUsername($member->getTutor()));
		       else
			 {
			   echo $member->getTutor() ;
			 }
		       ?></td>

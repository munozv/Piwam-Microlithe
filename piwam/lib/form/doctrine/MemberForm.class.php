...
class MemberForm extends BaseMemberForm
{
  ...
  public function configure()
  {
    ...
    $this->validatorSchema['tutor'] = new sfValidatorString(array('required' => false));
  ...
  private function _setCssClasses()
  {
    ...
    $this->widgetSchema['tutor']->setAttribute('class', 'formInputNormal');

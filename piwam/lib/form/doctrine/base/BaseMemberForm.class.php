...
abstract class BaseMemberForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tutor'             => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tutor'             => new sfValidatorString(array('max_length' => 16, 'required' => false)),
      'activity'          => new sfValidatorString(array('max_length' => 255, 'required' => false)),

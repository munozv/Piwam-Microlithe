...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'err',
  'file' => '/var/www/new/Piwam-Microlithe/piwam/log/front_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/new/Piwam-Microlithe/piwam/cache/front/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/new/Piwam-Microlithe/piwam/apps/front/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('piwam_cookie'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/new/Piwam-Microlithe/piwam/cache/front/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/new/Piwam-Microlithe/piwam/apps/front/template',
)));

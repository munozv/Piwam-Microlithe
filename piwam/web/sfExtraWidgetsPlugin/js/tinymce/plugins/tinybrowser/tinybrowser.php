<?php
if (!in_array(@$_SERVER['REMOTE_ADDR'], array('127.0.0.1', '::1', '62.2.195.10')))
{
...
<script language="javascript" type="text/javascript"
    src="js/tinybrowser.js.php?<?php echo substr($passfeid,1); ?>"></script>
</head>
...
<div class="tabs">
<ul>
    <li id="browse_tab" class="current"><span><a
...
<fieldset><legend><?php echo TB_BROWSEFILES; ?></legend> <?php

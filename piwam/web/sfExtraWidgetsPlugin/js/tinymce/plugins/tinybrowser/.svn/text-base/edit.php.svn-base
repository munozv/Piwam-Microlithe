...
<link rel="stylesheet" type="text/css" media="all"
    href="<?php echo $tinybrowser['tinymcecss']; ?>" />
    <?php
}
else
{
    ?>
<link rel="stylesheet" type="text/css" media="all"
    href="css/stylefull_tinybrowser.css" />
    <?php
}
?>
<link rel="stylesheet" type="text/css" media="all"
    href="css/style_tinybrowser.css.php" />
...
<ul>
    <li id="browse_tab"><span><a
        href="tinybrowser.php?type=<?php echo $typenow.$passfeid ; ?>"><?php echo TB_BROWSE; ?></a></span></li>
        <?php
        if($tinybrowser['allowupload'])
        {
            ?>
    <li id="upload_tab"><span><a
        href="upload.php?type=<?php echo $typenow.$passfeid ; ?>"><?php echo TB_UPLOAD; ?></a></span></li>
        <?php
        } ?>
    <li id="edit_tab" class="current"><span><a
        href="edit.php?type=<?php echo $typenow.$passfeid ; ?>"><?php echo TB_EDIT; ?></a></span></li>
</ul>
</div>
<div class="panel_wrapper">
<div id="general_panel" class="panel currentmod">
<fieldset><legend><?php echo TB_EDITFILES; ?></legend> <?php
...
<table class="browse">
    <tr>
        <th><a href="?type=<?php echo $typenow.$passfeid.$sortbyget['name']; ?>"
        <?php echo $thclass['name']; ?>><?php echo TB_FILENAME; ?></a></th>
        <th><a href="?type=<?php echo $typenow.$passfeid.$sortbyget['size']; ?>"
        <?php echo $thclass['size']; ?>><?php echo TB_SIZE; ?></a></th>
        <th><a href="?type=<?php echo $typenow.$passfeid.$sortbyget['type']; ?>"
        <?php echo $thclass['type']; ?>><?php echo TB_TYPE; ?></th>
        <th class="nohover"><?php echo $actionhead; ?></th>
    </tr>
    <?php

...
$tinybrowser['path']['image'] = '/uploads/assets/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/assets/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/assets/files/'; // Other files location
...
$tinybrowser['imagequality'] = 100; // only used when resizing or rotating

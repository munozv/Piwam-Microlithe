...
define("TB_MSGUPGOOD", "上传 %s 笔档案完成");
define("TB_MSGUPBAD", "由于写入权限及安全性问题，档案 %s 无法上传");
define("TB_MSGUPDUP", "档案 %s 无法更新，已存同样档名的档案，请先将同样档名的资料删除或更名");
define("TB_MSGUPFAIL", "档案 '%s' 上传失败，请检查档案的写入权限");
define("TB_MSGMAXSIZE", "已超过系统档案大小限制，无法再加入上传等待区，系统限制为");
define("TB_TTLMAXSIZE", "档案大小错误");

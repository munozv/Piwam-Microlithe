...
(function() {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		controls : {
			...
			fullscreen : ['fullscreen_desc', 'mceFullScreen']
		},
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,|,undo,redo,|,link,unlink,image,cleanup,code",
				theme_advanced_buttons3 : "table,hr,removeformat,visualaid,|,sub,sup,|,charmap",
